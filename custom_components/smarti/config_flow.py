    ...
    async def async_step_mode(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                ...
                "manual_description": "This option keeps your Home Assistant as-is but will require your to donwload all cards required by SMARTi yourself (via HACs or manually). Read more about this at our github repo",
            },
            errors=errors,
        )
